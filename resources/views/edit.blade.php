...
<head>
    ...
    <script src="{{asset('assets/js/redaktor.js')}}" defer></script>
    ...
    <script src="{{asset('assets/js/edit_validation.js')}}" defer></script>
                    ...
                    <div class="add_slides" id="add_slides">
                        <div class="add_slide">
                            <div class="modal">
                                <div class="modal_add_inner">
                                    <div class="modal_add_left">
                                        <div>
                                            ...
                                            <div class="form">
                                                ...
                                                @endphp
                                                <textarea name="name" id="textarea" rows="3" placeholder="название урока">@if(old('name')){{old('name')}}@else{{$lesson->name}}@endif</textarea>
                                                @error('name')
                                                <p class="error red">{{$message}}</p>
                                                @enderror
                                        ...
                                        <div>
                                            ...
                                            <div class="form">
                                                <form enctype="multipart/form-data">
                                                    <input type="file" value="" onchange="checkFileUpload()" name="foto" id="fileInput" accept=".jpg , .png , .jpeg">
                                                </form>
                                    ...
                                    <div class="modal_add_right">
                                        ...
                                        <img class="itog_image" src="{{$dataURI}}" alt="" class="src">
                            ...
                            <div class="add_content_down">
                                <button onclick="goToSlide(0)" class="button black_btn" id="prev_add" disabled><img src="{{asset('assets/img/arrow_white.svg')}}" alt="" class="white_arrow white_arrow_reverse">
                                    <p class="text2">Предыдущий шаг</p>
                                </button>

                                <button onclick="goToSlide(1)" class="button black_btn" id="first_add_step" disabled>
                                    <p class="text2">Следующий шаг</p> <img src="{{asset('assets/img/arrow_white.svg')}}" alt="" class="white_arrow">
                                </button>
                        ...
                        <div class="add_slide">
                            <div class="redaktor">
                                @if(old('text')){{old('text')}}@else {!! $lesson->text !!} @endif
                            </div>

                            <br> <br>
                            <div class="add_content_down">
                                <button onclick="goToSlide(0)" class="button black_btn" id="prev_add"><img src="{{asset('assets/img/arrow_white.svg')}}" alt="" class="white_arrow white_arrow_reverse">
                                    <p class="text2">Предыдущий шаг</p>
                                </button>
                        ...
                        <div class="add_slide">
                            <div class="modal">
                                <div class="words_add_inner">
                                    ...
                                    <div class="chose_words" id="chose_words">
                                        ...
                                        $lesson_words = json_decode($fucks);


                                        @endphp

                                        @foreach ($lesson_words as $word)
                                        @php
                                        $lesson_word = Word::find($word);
                                        @endphp
                                        @if ($lesson_word )
                                        <div class="word_card" data-card="{{$word}}">
                                            <div class="word_card_up">
                                                <div class="word_card_left">

                                                    <h3 data-original="{{$lesson_word->original}}">{{$lesson_word->original}}</h3>
                                                    <p data-translate="{{$lesson_word->translate}}" class="text2_reg">{{$lesson_word->translate}}</p>
                                                </div>
                                        ...
                                        @php
                                        $other_words = Word::whereNotIn('id', $lesson_words)->get();
                                        @endphp
                                        @foreach ($other_words->reverse() as $word)
                            ...
                            <br> <br>
                            <div class="add_content_down">
                                <button onclick="goToSlide(1)" class="button black_btn" id="prev_add"><img src="{{asset('assets/img/arrow_white.svg')}}" alt="" class="white_arrow white_arrow_reverse">
                                    <p class="text2">Предыдущий шаг</p>
                                </button>

                                <button>
                                    <input type="submit" name="fuck" value="Сохранить урок" disabled class="text2 button black_btn" id="third_add_step">
                                    </input>
                                </button>
