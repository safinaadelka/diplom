        ...
        (f
            ...
            : k !== m &&
              (void 0 === $jscomp.propertyToPolyfillSymbol[a] &&
                  ((m = (1e9 * Math.random()) >>> 0),
                  ($jscomp.propertyToPolyfillSymbol[a] =
                      $jscomp.IS_SYMBOL_NATIVE
...
Array.from ||
    (Array.from = (function () {
        var f = Object.prototype.toString,
            k = function (l) {
                return (
                    "function" === typeof l || "[object Function]" === f.call(l)
                );
            },
            m = Math.pow(2, 53) - 1;
        return function (l) {
...
if ("undefined" != typeof responsiveVoice)
    ...
    var ResponsiveVoice = function () {
            ...
            a.responsivevoices = [
                {
                    ...
                    lang: "en-GB",
                    voiceIDs: [
                        3, 7, 171, 201, 5, 1, 528, 257, 286, 342, 258, 287, 343,
                        8,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "en-US",
                    voiceIDs: [
                        432, 433, 434, 40, 41, 42, 383, 205, 204, 43, 481, 173,
                        235, 283, 339, 408, 44,
                    ],
                },
                {
                    ...
                    lang: "en-US",
                    voiceIDs: [
                        431, 39, 234, 282, 338, 236, 284, 340, 2, 4, 0, 75, 195,
                        169,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "zh-CN",
                    voiceIDs: [
                        249, 58, 59, 452, 380, 281, 231, 155, 60, 513, 191, 268,
                        297, 353, 269, 298, 354, 409, 61,
                    ],
                },
                {
                    name: "Chinese Male",
                ...
                },
                {
                    ...
                    lang: "zh-HK",
                    voiceIDs: [
                        463, 464, 192, 193, 232, 250, 251, 270, 299, 355, 409,
                        444, 252,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "zh-TW",
                    voiceIDs: [
                        469, 194, 233, 253, 254, 305, 322, 361, 384, 319, 336,
                        375, 409, 255,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "de-DE",
                    voiceIDs: [
                        27, 28, 29, 30, 78, 170, 275, 199, 31, 502, 261, 290,
                        346, 262, 291, 347, 32,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "fr-FR",
                    voiceIDs: [
                        240, 21, 22, 23, 77, 178, 279, 210, 493, 266, 295, 351,
                        304, 321, 360, 26,
                    ],
                    rate: 0.2,
                ...
                },
                {
                    ...
                    lang: "it-IT",
                    voiceIDs: [
                        242, 33, 34, 35, 36, 37, 79, 181, 216, 508, 271, 300,
                        356, 38,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "ja-JP",
                    voiceIDs: [
                        51, 280, 217, 52, 153, 517, 182, 273, 302, 358, 274,
                        303, 359, 53,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "ko-KR",
                    voiceIDs: [
                        54, 55, 56, 156, 183, 218, 466, 306, 323, 362, 384, 57,
                    ],
                },
                {
                    name: "Korean Male",
                ...
                },
                {
                    ...
                    lang: "pl-PL",
                    voiceIDs: [
                        244, 120, 119, 121, 185, 222, 505, 267, 296, 352, 122,
                    ],
                },
                {
                    name: "Polish Male",
                ...
                },
                {
                    ...
                    lang: "pt-BR",
                    voiceIDs: [
                        128, 127, 129, 187, 224, 479, 272, 301, 357, 130,
                    ],
                },
                {
                ...
                },
                {
                    ...
                    lang: "ru-RU",
                    voiceIDs: [
                        246, 47, 48, 83, 468, 188, 226, 260, 289, 345, 49,
                    ],
                },
                {
                    name: "Russian Male",
                ...
                },
                {
                    ...
                    lang: "es-ES",
                    voiceIDs: [
                        19, 238, 16, 17, 18, 20, 76, 174, 207, 514, 521, 263,
                        292, 348, 264, 293, 349, 15,
                    ],
                },
                {
                    name: "Spanish Male",
                ...
                },
                {
                    ...
                    lang: "es-MX",
                    voiceIDs: [
                        239, 137, 136, 138, 175, 208, 265, 294, 350, 139,
                    ],
                },
                {
            ...
            a.init = function () {
                ...
                (a.iOS || a.is_android || a.is_safari) &&
                    a.enableWindowClickHook();
                a.Dispatch("OnLoad");
            };
                ...
                if (null == b) a.log("No text provided");
                    ...
                    if (a.isPlaying())
                        ...
                        if (g) {
                            ...
                            console.error(
                                "Selected voice does not exist: " + c
                            ),
            ...
            a.setDefaultRate = function (b) {
                ...
                isNaN(b)
                    ...
                    : 0 === b
                    ? console.error(
                          "[responsiveVoice.setDefaultRate] rate must be > 0"
                      )
                    : 1.5 < b
                    ? console.error(
            ...
            a.RemoveEventListener = function (b, c) {
                a[b + "_callbacks"] &&
                    ...
                    a[b + "_callbacks"].splice(
                        a[b + "_callbacks"].indexOf(c),
                        1
                    );
            };
            ...
            a.checkSpeechAllowed = function (b) {
                ...
                if (
                    ...
                    if (2 < a.allowSpeechDiv_appearances)
                        return (
                            console.log(
                                "ResponsiveVoice: Speech not allowed by user"
                            ),
                            !1
                        );
